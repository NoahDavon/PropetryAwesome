...
export default function CompoundCard({property}: Props) {
  return (
    <div style={{backgroundImage: `url(compoundImages/${property.ID}.png)`}} className={`bg-cover group hover:scale-110 transition-all rounded-xl w-64 lg:w-96 h-64 lg:h-96 relative`}>
